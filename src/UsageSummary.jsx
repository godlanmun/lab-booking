...
import { Loader2, DoorOpen, Camera, ClipboardList } from "lucide-react";
                ...
                <div className="space-y-2">
                  {bookings.map((b) => (
                    ...
                    >
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full border shrink-0 ml-3 ${STATUS_STYLE[b.status]}`}>
